...
import com.projoker.smart_bazar.service.cart.ICartItemService;
import com.projoker.smart_bazar.service.cart.ICartService;
import com.projoker.smart_bazar.service.user.IUserService;
...
@Tag(
        name="CartItems",
        description = "Api to view implement operations with CartItems like add item to cart or Remove it"
)
public class CartItemController {
    ...
    public ResponseEntity<ApiResponse> removeItemFromCart(@PathVariable Long cartId,
        ...
        try {
            cartItemService.removalItemFromCart(cartId,itemId);
            return ResponseEntity.ok(new ApiResponse("Item Removed Succesfully",null));
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(NOT_FOUND).body(new ApiResponse(e.getMessage(),null));
        }
    }
